...
import {ManageAccountPetitionStagesService} from './manageaccount-petitiontypestages.service';
...
@Component({
    ...
    templateUrl: './manageaccount-petitiontypestages.component.html',
    styleUrls: ['./manageaccount-petitiontypestages.component.sass']
})
