...
import { PetitionDetailsNewService } from './petition-details-new.service';
...
@Component({
    selector: 'app-petition-details-new',
    templateUrl: './petition-details-new.component.html',
    styleUrls: ['./petition-details-new.component.sass']
})
export class PetitionDetailsNewComponent implements OnInit {
    isNotesEdit;
    private users;
    ...
    constructor(public appService: AppService, private petitionDetailsService: PetitionDetailsNewService,
            ...
            .subscribe((res) => {
                ...
                if (res['petitionTypeId'] !== undefined) {
                    this.petitionDetailsService.getPetitionStages(this.headerService.user.accountId, res['petitionTypeId'])
                        .subscribe((res1) => {
                            this.petitionStages = res1['petitionStageList'];
                        });
                }
    ...
    onSavePetitionInfoClick() {
        ...
        if (this.petitionDetails['name'] === '' || this.petitionDetails['name'] == null
          || this.petitionDetails['name'] === undefined && this.petitionDetails['status'] === ''
          || this.petitionDetails['status'] == null || this.petitionDetails['status'] === undefined
          && this.petitionDetails['status'] === '' || this.petitionDetails['status'] == null
