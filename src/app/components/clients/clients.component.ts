...
export class ClientsComponent implements OnInit {
    ...
    constructor(private clientService: ClientsService, private appservice: AppService, private router: Router, private dialogService: DialogService, private menuComponent: MenuComponent) {
