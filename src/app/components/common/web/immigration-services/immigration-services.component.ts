...
export class websiteImmigrationServicesComponent extends DialogComponent<ConfirmModel, boolean> implements OnInit {
    ...
    loginSubmit(model: User, isValid: boolean) {
        if (isValid) {
            this.loginservice.login(model).subscribe((res: any) => {
                ...
                //if(res.uiBuildNumber != null && websiteImmigrationServicesComponent.uiBuildNumber != res.uiBuildNumber){
                //  this.close();
                //  this.dialogService.addDialog(ConfirmComponent, {
                //    title: 'Information',
                ...
                if (res.statusCode == "FAILURE") {
                    ...
                    if (res['resetPassword'] != undefined
                        ...
                        if (res.hasMultipleRoles == true) {
                            ...
                            this.dialogService.addDialog(websiteImmigrationServicesComponent, {
                                selectrole: true,
                                getloginpage: false,
