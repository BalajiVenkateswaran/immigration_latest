...
import {webPricingService} from "./pricing.component.service";
  ...
  loginSubmit(model: User, isValid: boolean) {
    if (isValid) {
      this.loginservice.login(model).subscribe((res: any) => {
        ...
        //if(res.uiBuildNumber != null && webPricingComponent.uiBuildNumber != res.uiBuildNumber){
        //  this.close();
        //  this.dialogService.addDialog(ConfirmComponent, {
        //    title: 'Information',
        ...
        //}
          ...
          if (res['resetPassword'] != undefined
            ...
            if (res.hasMultipleRoles == true) {
              ...
              this.dialogService.addDialog(webPricingComponent, {
                selectrole: true,
                getloginpage: false,
