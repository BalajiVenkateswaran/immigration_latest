...
import {webAboutusService} from "./aboutus.service";
...
export class webAboutusComponent extends DialogComponent<ConfirmModel, boolean> implements OnInit {
  ...
  loginSubmit(model: User, isValid: boolean) {
    if (isValid) {
      this.loginservice.login(model).subscribe((res: any) => {
        ...
        //if(res.uiBuildNumber != null && webAboutusComponent.uiBuildNumber != res.uiBuildNumber){
        //  this.close();
        //  this.dialogService.addDialog(ConfirmComponent, {
        //    title: 'Information',
        ...
        //}
          ...
          if (res['resetPassword'] != undefined
            ...
            if (res.hasMultipleRoles == true) {
              ...
              this.dialogService.addDialog(webAboutusComponent, {
                selectrole: true,
                getloginpage: false,
