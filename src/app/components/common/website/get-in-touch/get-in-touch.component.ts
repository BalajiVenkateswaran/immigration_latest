...
import {webGetinTouchService} from "./get-in-touch.service";
...
export class webGetinTouchComponent extends DialogComponent<ConfirmModel, boolean> implements OnInit {
  ...
  loginSubmit(model: User, isValid: boolean) {
    if (isValid) {
      this.loginservice.login(model).subscribe((res: any) => {
        ...
        //if(res.uiBuildNumber != null && webGetinTouchComponent.uiBuildNumber != res.uiBuildNumber){
        //  this.close();
        //  this.dialogService.addDialog(ConfirmComponent, {
        //    title: 'Information',
        ...
        //}
          ...
          if (res['resetPassword'] != undefined
            ...
            if (res.hasMultipleRoles == true) {
              ...
              this.dialogService.addDialog(webGetinTouchComponent, {
                selectrole: true,
                getloginpage: false,
