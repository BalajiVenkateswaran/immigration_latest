...
import {petitionstagsreportsservice} from "./petitiontagsreports.service";


@Component({
    selector: 'app-petitiontags-report',
    templateUrl: './petitiontagsreports.component.html',
    styleUrls: ['./petitiontagsreports.component.sass']
})
