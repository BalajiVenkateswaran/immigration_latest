...
import { QuestionnaireClientViewService } from './i129.service';
...
export class QuestionnaireI129ClientComponent implements OnInit {
    ...
    constructor(private appService: AppService, private questionnaireClientViewService: QuestionnaireClientViewService, 
